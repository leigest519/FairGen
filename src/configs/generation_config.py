...
class GenerationConfig(BaseModel):
    ...
    # FairGen gating distribution and adapter strength
    pmf: list[float] = None  # optional non-uniform probabilities over categories
    alpha: float = 1.0       # adapter strength scaling
